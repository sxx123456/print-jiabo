	...
	<view class="content">
		<view class="body">
			...
			<view style='margin-top:4%;display: flex;flex-direction: row;'>
			   ...
			   <button type='primary' @tap='LH' :loading='isLabelSend' :disabled='isLabelSend'>拉回</button>
	...
	export default {
		data() {
			return {
				...
				canvasWidth: 180,
				canvasHeight: 180,
				imageSrc: '../../static/img/biaoqian.png',
				// imageSrc:'https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1598164031076&di=2173659c97fe3f0fb86e070edff58088&imgtype=0&src=http%3A%2F%2Fwww.chongshang.com.cn%2FProductmain%2Fttp244_ind-2.jpg',
				buffSize: [],
				buffIndex: 0,
				printNum: [],
				printNumIndex: 0,
		...
		methods:{
			...
			labelTest(){
				...
				command.setSize(600, 400)
				// command.setGap(3)
				command.setCls()
				//第一根竖线
				command.setBar(10,30,2,340)
				//第二根竖线
				command.setBar(570,30,2,340)
				//第一根横线
				command.setBar(10,30,580,2)
				//第二根横线
				command.setBar(10,70,580,2)
				//  第三根横线
				command.setBar(10,110,580,2)
				//第二行分割线
				command.setBar(420,70,2,40)
				//  第四根横线
				command.setBar(10,150,580,2)
				//第三行分割线
				command.setBar(180,110,2,40)
				//  第五根横线
				command.setBar(10,250,580,2)
				//  第六根横线
				command.setBar(10,370,580,2)
				//第五行分割线
				command.setBar(180,250,2,120)
				//交接，分析上面那根线
				command.setBar(180,340,400,2)
				//最后一行分割线
				command.setBar(330,340,2,30)
				//最后一行分割线
				command.setBar(450,340,2,30)
				// command.setQR(40, 120, "L", 5, "A", "www.smarnet.cc佳博智汇")
				command.setText(30, 40, "TSS24.BF2", 1, 1, "测试复制采样")
				command.setText(30, 80, "TSS24.BF2", 1, 1, "采样地点：西和天平")
				command.setText(430, 80, "TSS24.BF2", 1, 1, "频次：1")
				command.setText(30, 120, "TSS24.BF2", 1, 1, "地表水")
				command.setText(190, 120, "TSS24.BF2", 1, 1, "BS32424234-23442")
				command.setText(30, 160, "TSS24.BF2", 1, 1, "砷，硒")
				command.setQR(60, 260, "L", 3, "A", "www.smarnet.cc佳博智汇")
				command.setText(190, 260, "TSS24.BF2", 1, 1, "加150mlHCL")
				command.setBox(190,350,205,365,1)
				command.setBox(340, 350, 355,365,1)
				command.setText(215, 345, "TSS24.BF2", 1, 1, "交接")
				command.setText(365, 345, "TSS24.BF2", 1, 1, "分析")
				
				// command.setText(170, 90, "TSS24.BF2", 1, 1, "测试数字12345678")
				// command.setText(0, 120, "TSS24.BF2", 1, 1, "测试英文abcdefg")
